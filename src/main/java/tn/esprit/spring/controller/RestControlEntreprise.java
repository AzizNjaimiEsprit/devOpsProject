...
import tn.esprit.spring.pojo.DepartementPOJO;
import tn.esprit.spring.pojo.EntreprisePOJO;
...
public class RestControlEntreprise {
	...
	@ResponseBody
	public int ajouterEntreprise(@RequestBody EntreprisePOJO ssiiConsulting) {
    ...
    // http://localhost:8081/SpringMVC/servlet/ajouterDepartement
 	...
 	@ResponseBody
	public int ajouterDepartement(@RequestBody DepartementPOJO dep) {
